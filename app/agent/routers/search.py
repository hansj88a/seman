"""검색 API: 검색어 → OpenSearch 상품 코드 조회."""
from fastapi import APIRouter, Depends, HTTPException

from app.models import SearchQueryParams, SearchResponse
from app.agent.services.search_service import search_product_codes
