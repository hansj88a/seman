"""
동기화 API: S3 → OpenSearch 등록 (manager 서비스)
"""
from fastapi import APIRouter, HTTPException

from app.models.sync import SyncStartResponse
from app.packages.manager.services.sync_service import run_sync
...
@router.post(
    "/sync/start",
    summary="동기화 시작",
    description="S3 특정 경로에서 상품 정보를 가져와 OpenSearch에 등록합니다.",
